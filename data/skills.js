export const skillCategories = [
  {
    name: "Languages",
    skills: [
      { name: "Python", level: 95, status: "proficient" },
      { name: "C++", level: 90, status: "proficient" },
      { name: "Rust", level: 40, status: "learning" },
      { name: "Go", level: 40, status: "learning" },
    ],
  },
  {
    name: "ML & GPU",
  ...
  },
  {
    name: "Systems",
    skills: [
      { name: "OS Internals", level: 55, status: "active" },
      { name: "Networking", level: 50, status: "active" },
      { name: "Memory Management", level: 55, status: "active" },
    ],
  },
  {
